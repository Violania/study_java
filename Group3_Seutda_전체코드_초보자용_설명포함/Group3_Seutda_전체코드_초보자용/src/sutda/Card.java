...
public class Card {
    ...
    static Hand evaluate(Card a, Card b) {
        ...
        if (m1 == m2) {
            return new Hand(getDdangRank(m1));
        }
        ...
        int kkut = (m1 + m2) % 10;
        return new Hand(getKkutRank(kkut));
    }

    /** 같은 월 두 장일 때 해당 땡 족보를 찾습니다. */
    private static Rank getDdangRank(int month) {
        switch (month) {
            case 10: return Rank.DDANG_10;
            case 9: return Rank.DDANG_9;
            case 8: return Rank.DDANG_8;
            case 7: return Rank.DDANG_7;
            case 6: return Rank.DDANG_6;
            case 5: return Rank.DDANG_5;
            case 4: return Rank.DDANG_4;
            case 3: return Rank.DDANG_3;
            case 2: return Rank.DDANG_2;
            default: return Rank.DDANG_1;
        }
    }

    /** 두 카드의 월 합으로 1끗~9끗 또는 망통을 찾습니다. */
    private static Rank getKkutRank(int kkut) {
        switch (kkut) {
            case 9: return Rank.KKUT_9;
            case 8: return Rank.KKUT_8;
            case 7: return Rank.KKUT_7;
            case 6: return Rank.KKUT_6;
            case 5: return Rank.KKUT_5;
            case 4: return Rank.KKUT_4;
            case 3: return Rank.KKUT_3;
            case 2: return Rank.KKUT_2;
            case 1: return Rank.KKUT_1;
            default: return Rank.MANG_TONG;
        }
    }
